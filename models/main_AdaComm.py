"""Script to run the baseline with AdaComm strategy"""
import argparse
import importlib
import numpy as np
import os
...
from utils.comm_adapter import CommAdapter
...
def main():
    ...
    # AdaComm: comm adapter
    adapter = CommAdapter(cfg)
    ...
    for i in range(num_rounds):
        ...
        # AdaComm: adapter collests time and losses
        adapter.collect_info(simulate_time, loss)
        '''
        try:
